...
\includegraphics{jonboy1987-intro_to_r_files/figure-latex/plot-girls-vs-year-1.pdf}
...
\includegraphics{jonboy1987-intro_to_r_files/figure-latex/plot-girls-vs-year-line-1.pdf}
...
\includegraphics{jonboy1987-intro_to_r_files/figure-latex/plot-total-vs-year-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(arbuthnot}\OperatorTok{$}\NormalTok{year, arbuthnot}\OperatorTok{$}\NormalTok{boys }\OperatorTok{/}\StringTok{ }\NormalTok{(arbuthnot}\OperatorTok{$}\NormalTok{boys }\OperatorTok{+}\StringTok{ }\NormalTok{arbuthnot}\OperatorTok{$}\NormalTok{girls))}
\end{Highlighting}
\end{Shaded}

\includegraphics{jonboy1987-intro_to_r_files/figure-latex/plot-boys-over-time-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{boy_to_girl_ratio_present <-}\StringTok{ }\NormalTok{present}\OperatorTok{$}\NormalTok{boys }\OperatorTok{/}\StringTok{ }\NormalTok{present}\OperatorTok{$}\NormalTok{girls}
\KeywordTok{plot}\NormalTok{(present}\OperatorTok{$}\NormalTok{year, boy_to_girl_ratio_present)}
\end{Highlighting}
\end{Shaded}

\includegraphics{jonboy1987-intro_to_r_files/figure-latex/boy-to-girl-ratio-present-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# get total per year}
\NormalTok{total_births <-}\StringTok{ }\NormalTok{present}\OperatorTok{$}\NormalTok{boys }\OperatorTok{+}\StringTok{ }\NormalTok{present}\OperatorTok{$}\NormalTok{girls}
\CommentTok{# which.max(total_births) gives the index of the largest value}
\NormalTok{present[}\KeywordTok{which.max}\NormalTok{(total_births), }\StringTok{"year"}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
